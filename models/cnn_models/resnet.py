"""
MedXplain-Simple — ResNet visual feature extractor for medical imaging.
...
class MedicalResNet(BaseVisualEncoder):
    ...
    def __init__(
        ...
        super().__init__(model_name="resnet50", num_classes=num_classes, device=device)
